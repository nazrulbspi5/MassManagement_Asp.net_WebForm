<%@ Page Title="Deposit Entry" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Deposit.aspx.cs" Inherits="Deposit" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="Card-Body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <asp:DropDownList ID="ddlMember" DataValueField="Name" DataTextField="Name" AppendDataBoundItems="true" CssClass="form-control" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <asp:TextBox runat="server" ID="tbxDate" CssClass="form-control" />
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="Card-Body">
                            <div class="table-responsive">
                                <asp:GridView ID="gvMillHistory" DataKeyNames="ID" ShowFooter="true" OnRowDataBound="gvMillHistory_RowDataBound" OnSelectedIndexChanged="gvMillHistory_SelectedIndexChanged" OnRowDeleting="gvMillHistory_OnRowDeleting" runat="server" CssClass="table table-bordered table-striped"
